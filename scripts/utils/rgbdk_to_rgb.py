...
def rgbdk_to_rgb(input_path, output_path):
    ...
    output_file = os.path.join(output_path, 'rgb.jpg')
...
if __name__ == "__main__":
    ...
    parser.add_argument('--output_path', type=str, required=True, help="Directory to save the output RGB numpy file.")
    
    args = parser.parse_args()
    
    rgbdk_to_rgb(args.input_path, args.output_path)
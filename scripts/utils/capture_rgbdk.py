    ...
    try:
        ...
        if capture.color is not None and capture.depth is not None:
            ...
            if to_images:
                ...
                rgb_path = os.path.join(dir_path, "bgr_frame.png")
                depth_path = os.path.join(dir_path, "depth_frame.png")
                ...
                npy_path = os.path.join(dir_path, "rgbdk.npy")
...
if __name__ == "__main__":
    ...
    capture_rgbd(args.dir_path, args.to_images)

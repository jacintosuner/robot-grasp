...
if __name__ == "__main__":
    ...
    # Load data
    cam_id = 0
    data_dirname = os.path.expanduser("~/robot-grasp/data/camera_calibration")
    ...
    # if cam_id == 2:
    #     T += np.array([[0, 0, 0, 0.09],
    #                     [ 0, 0, 0, 0.12],
    #                     [ 0, 0, 0, 0],
    #                     [ 0, 0, 0, 0]])
    # elif cam_id == 1:
    #     T += np.array([[0, 0, 0, -0.07],
    #                     [ 0, 0, 0, 0.09],
    #                     [ 0, 0, 0, -0.01],
    #                     [ 0, 0, 0, 0]])
    ...
    calib_dirname = os.path.expanduser("~/robot-grasp/data/camera_calibration")
